  ...
  return (
    <div>
      <Carousel autoplay arrows={true} dots={false}>
        <div className="!w-[1400px] lg:!w-full">
          <Image
            preview={false}
      ...
      <section className="sm: py-7 sm: pl-3 md:py-10 md:pl-4 xl:py-10 xl:pl-10">
        ...
        <Row
          gutter={12}
          className="flex !overflow-x-auto !overflow-y-hidden !flex-nowrap !scroll-smooth max-w-full"
          style={{
            scrollbarWidth: 'none',
      ...
      {/* <section className="sm: p-2 md:p-4 xl:p-10 md:mb-8 xl:mb-0">
        <Row gutter={[24, 8]}>
      ...
      <Row>
        <Col className="relative overflow-hidden sm: !mt-5 md:!mt-0">
          ...
          <Space
            ...
            size={'middle'}
          >
            <span className="uppercase text-white sm: text-2xl md:text-[50px] xl:text-[80px] font-bold sm: leading-2 lg:leading-10 xl:leading-22">
              CASUALWEAR COLLECTION
            </span>
            <p className="text-white sm: text-xs  md:text-base xl:text-lg font-medium">
              Giảm 40k đơn từ 299k dành cho khách hàng mua lần đầu tại website!
            </p>
            <button className="bg-white flex items-center md:text-xl sm: py-2 sm: px-8 md:px-14 md:py-4 rounded-full cursor-pointer hover:bg-gray-100">
              Mua ngay
              <BsArrowRight className="mt-2 ml-2 text-xl" />
            </button>
          </Space>
        </Col>
      </Row>
      ...
      <Row className="sm: p-3 md:p-4 xl:p-10 mb-10 xl:mb-0">
