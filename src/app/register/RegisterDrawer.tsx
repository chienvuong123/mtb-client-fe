...
import { Drawer, Col, Flex, Image, Row } from 'antd';
import UIInput from '@/components/ui/UIInput';
import { IoMdClose } from 'react-icons/io';

interface IRegisterDrawerProps {
  open: boolean;
  onClose: () => void;
}

const RegisterDrawer: React.FC<IRegisterDrawerProps> = ({ open, onClose }) => {
        ...
        <>
          <div className="p-2">
            ...
            <Flex justify="space-between" align="center">
              ...
              <div
                className="cursor-pointer bg-black rounded-full h-8 w-8 flex items-center justify-center mb-6"
                onClick={handleClose}
              >
